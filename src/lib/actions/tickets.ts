...
let tickets: Ticket[] = [
    ...
    { id: 6, patientName: 'Fitri Carlina', patientId: 'P006', room: '101A', diet: 'Bubur', birthDate: new Date('1987-05-29'), mealTime: 'Pagi', ticketDate: new Date(), createdAt: new Date(), updatedAt: new Date() },
    { id: 7, patientName: 'Giring Ganesha', patientId: 'P007', room: '102B', diet: 'Biasa', birthDate: new Date('1983-07-14'), mealTime: 'Siang', ticketDate: new Date(), createdAt: new Date(), updatedAt: new Date() },
    { id: 8, patientName: 'Hesti Purwadinata', patientId: 'P008', room: '201A', diet: 'Cair', birthDate: new Date('1983-06-15'), mealTime: 'Malam', ticketDate: new Date(), createdAt: new Date(), updatedAt: new Date() },
    { id: 9, patientName: 'Indra Bekti', patientId: 'P009', room: '202B', diet: 'Sonde', birthDate: new Date('1977-12-28'), mealTime: 'Pagi', ticketDate: new Date(), createdAt: new Date(), updatedAt: new Date() },
    { id: 10, patientName: 'Jihan Fahira', patientId: 'P010', room: '301A', diet: 'Biasa', birthDate: new Date('1978-02-06'), mealTime: 'Siang', ticketDate: new Date(Date.now() - 48 * 60 * 60 * 1000), createdAt: new Date(), updatedAt: new Date() },
    { id: 11, patientName: 'Krisdayanti', patientId: 'P011', room: '302B', diet: 'Bubur', birthDate: new Date('1975-03-24'), mealTime: 'Malam', ticketDate: new Date(), createdAt: new Date(), updatedAt: new Date() },
    { id: 12, patientName: 'Luna Maya', patientId: 'P012', room: '401A', diet: 'Biasa', birthDate: new Date('1983-08-26'), mealTime: 'Pagi', ticketDate: new Date(), createdAt: new Date(), updatedAt: new Date() },
];
let nextId = 13;
...
export const getTickets = cache(async ({
  ...
  try {
    ...
    const sortedTickets = filteredTickets.sort((a, b) => b.createdAt.getTime() - a.createdAt.getTime());
